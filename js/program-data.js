 ...
 * ============================================================ */
// V8.4 (P2-#4) — موسّعة من 8 إلى 25+ تمرين، مع نقل الشرح التفصيلي من tab "أول مرة"
// كل تمرين له modal مستقل يفتح من زر ℹ️ — بدل صفحة wall-of-text طويلة
const EXERCISE_FORM_NOTES = {
  // ===== أجهزة الدفع (صدر + أكتاف + ترايسبس) =====
  "Chest Press": {
    title: "Chest Press — ضغط صدر",
    category: "push",
    formNote: "<b>الأسلوب الصحيح:</b><br>• اجلس وظهرك ملصوق بالمسند بالكامل<br>• امسك المقابض — لازم تكون بمستوى صدرك (عدّل المقعد لو مو بالمستوى)<br>• ادفع للأمام لين ذراعك تمتد (لكن لا تقفل الكوع 100%)<br>• ارجع <b>ببطء</b> — هذا الجزء الأهم، لا ترمي الوزن<br><br><b>أول وزن تجربه:</b> ١٠-١٥ كجم<br><br>⚠️ لا ترمي الوزن للخلف، تحكّم في الحركة كاملة.",
    gif: "assets/gifs/chest-press.svg"
  },
  "Pectoral Fly": {
    title: "Pectoral Fly — تفتيح صدر",
    category: "push",
    formNote: "<b>الأسلوب الصحيح:</b><br>• اجلس وظهرك ملصوق<br>• امسك الذراعين اللي على الجوانب<br>• جيب الذراعين لقدام لين يلتقون أمام صدرك — حس بالضغط على الصدر<br>• ارجع <b>ببطء</b> لين تحس بتمدد في صدرك<br><br><b>أول وزن:</b> ٥-١٠ كجم<br><br>⚠️ لا تفتح أكثر من اللازم أول مرة — تجنّب إجهاد الكتف.",
    gif: "assets/gifs/pectoral-fly.svg"
  },
  "Shoulder Press": {
    title: "Shoulder Press — ضغط أكتاف",
    category: "push",
    formNote: "<b>الأسلوب الصحيح:</b><br>• اجلس — المقابض بمستوى أذنك تقريباً<br>• ادفع لفوق لين ذراعك تمتد (لا تقفل الكوع)<br>• انزل ببطء لين المقبض يرجع بمستوى أذنك<br><br><b>أول وزن:</b> ٥-١٠ كجم<br><br>⚠️ الكتف عضلة صغيرة — ابدأ خفيف وزد تدريجياً.",
    gif: "assets/gifs/shoulder-press.svg"
  },
  "Delts Machine": {
    title: "Delts Machine — كتف جانبي",
    category: "push",
    formNote: "<b>الأسلوب الصحيح:</b><br>• اجلس والوسائد على ذراعك من الخارج (فوق الكوع)<br>• ارفع ذراعك للجانب لين يوصل مستوى الكتف<br>• <b>لا ترفع أعلى من الكتف</b><br>• انزل ببطء<br><br><b>أول وزن:</b> ٥ كجم<br><br>⚠️ الحركة بطيئة ومتحكمة — لا أرجحة.",
    gif: "assets/gifs/delts-machine.svg"
  },
  "Arm Extension": {
    title: "Arm Extension — ترايسبس",
    category: "push",
    formNote: "<b>الأسلوب الصحيح:</b><br>• اجلس والكوع على الوسادة. امسك المقبض<br>• افرد ذراعك بالكامل لتحت<br>• ارجع ببطء<br><br><b>الكوع ثابت ما يتحرك</b>، بس الساعد يتحرك.<br><br><b>أول وزن:</b> ٥-١٠ كجم",
    gif: null
  },
  "Dips": {
    title: "Dips (Kneeling) — غمس بمساعدة",
    category: "push",
    formNote: "<b>الأسلوب الصحيح:</b><br>• اركب جهاز Kneeling Easy Chin Dip واركع على الوسادة السفلية (هذي تشيل جزء من وزنك)<br>• امسك المقابض الجانبية وافرد ذراعك لفوق<br>• انزل ببطء لين الكوع يوصل ٩٠ درجة — <b>لا تنزل أعمق</b><br>• ادفع نفسك لفوق<br><br><b>ابدأ بأثقل مساعدة</b> (أخف حِمل عليك) وكل أسبوع قلّل المساعدة شوي.<br><br>متى ما قدرت تسويها بدون مساعدة = انتقل لمحطة Chin Up/Dip العادية.",
    gif: null
  },

  // ===== أجهزة السحب (ظهر + بايسبس) =====
  "Lat Machine": {
    title: "Lat Machine — سحب عمودي",
    category: "pull",
    formNote: "<b>الأسلوب الصحيح:</b><br>• اجلس وثبّت فخذك تحت الوسادة عشان ما ترتفع<br>• امسك البار العريض من فوق بقبضة أعرض من كتفك<br>• اسحب البار لصدرك — <b>تخيّل إنك تحط كوعك في جيبك</b><br>• ارجع ببطء — لا تترك الوزن يرجع بسرعة<br><br><b>أول وزن:</b> ١٥-٢٠ كجم<br><br>⚠️ لا تسحب لخلف الرقبة — خطر على الكتف.",
    gif: "assets/gifs/lat-machine.svg"
  },
  "Low Row": {
    title: "Low Row — سحب أفقي",
    category: "pull",
    formNote: "<b>الأسلوب الصحيح:</b><br>• اجلس وصدرك ملصوق بالوسادة الأمامية<br>• امسك المقابض واسحب لصدرك — حاول تجمع لوحين ظهرك مع بعض<br>• ارجع ببطء<br><br><b>أول وزن:</b> ١٥-٢٠ كجم<br><br>⚠️ لا تستخدم الذراع فقط — الحركة من الظهر.",
    gif: "assets/gifs/low-row.svg"
  },
  "Vertical Traction": {
    title: "Vertical Traction — سحب عمودي (بديل)",
    category: "pull",
    formNote: "<b>الأسلوب الصحيح:</b><br>• مثل Lat Machine لكن بمقابض مستقلة<br>• اسحب لتحت لين المقبض بمستوى كتفك<br>• ارجع ببطء<br><br><b>أول وزن:</b> ١٥-٢٠ كجم",
    gif: null
  },
  "Pulley": {
    title: "Pulley — كابل متعدد",
    category: "pull",
    formNote: "<b>جهاز متعدد الاستخدامات:</b><br><br><b>للسحب الأفقي:</b><br>• اجلس على المقعد، امسك المقبض واسحبه لبطنك<br><br><b>للبايسبس:</b><br>• قف أمام الكابل السفلي<br>• امسك البار القصير واثنِ ذراعك لفوق<br><br><b>للترايسبس (Pushdown):</b><br>• قف أمام الكابل العلوي<br>• ادفع المقبض لتحت بكوع ثابت<br><br><b>أول وزن:</b> ١٠-١٥ كجم",
    gif: null
  },
  "Upper Back": {
    title: "Upper Back — أعلى الظهر",
    category: "pull",
    formNote: "<b>الأسلوب الصحيح:</b><br>• اجلس وصدرك على الوسادة<br>• امسك المقابض<br>• اسحب للخلف — ركّز على <b>جمع لوحين الظهر</b> مع بعض<br>• ارجع ببطء<br><br><b>أول وزن:</b> ١٠-١٥ كجم",
    gif: null
  },
  "Reverse Fly": {
    title: "Reverse Fly — خلف الكتف",
    category: "pull",
    formNote: "<b>الأسلوب الصحيح:</b><br>• اجلس ووجهك مقابل الجهاز (عكس Pectoral Fly)<br>• صدرك على الوسادة<br>• ادفع الذراعين للخلف — تخيّل إنك تفتح صدرك<br>• ارجع ببطء<br><br><b>أول وزن:</b> ٥ كجم<br><br>⚠️ عضلة صغيرة جداً — ابدأ خفيف.",
    gif: "assets/gifs/reverse-fly.svg"
  },
  "Arm Curl": {
    title: "Arm Curl — بايسبس",
    category: "pull",
    formNote: "<b>الأسلوب الصحيح:</b><br>• اجلس والكوع على الوسادة<br>• امسك المقبض من تحت<br>• اثنِ ذراعك لفوق — <b>الكوع ثابت تماماً</b><br>• انزل ببطء<br><br>⚠️ لا تفرد ذراعك ١٠٠٪ في الأسفل عشان تحمي المفصل.<br><br><b>أول وزن:</b> ٥-١٠ كجم",
    gif: null
  },
  "Chin Ups": {
    title: "Chin Ups (Kneeling) — عقلة بمساعدة",
    category: "pull",
    formNote: "<b>الأسلوب الصحيح:</b><br>• اركب جهاز Kneeling Easy Chin Dip واركع على الوسادة السفلية<br>• امسك البار العلوي بقبضة معكوسة (كفّك نحوك) بعرض الكتف<br>• اسحب نفسك لفوق لين ذقنك يعدّي البار<br>• انزل ببطء وبتحكم<br><br><b>ابدأ بأثقل مساعدة</b> وكل أسبوع قلّلها تدريجياً.<br><br><b>الهدف:</b> خلال ٤-٨ أسابيع تقدر تسوي العقلة بدون مساعدة على المحطة العادية.",
    gif: null
  },
  "Pulley Curl": {
    title: "Pulley Curl — بايسبس بالكابل",
    category: "pull",
    formNote: "<b>الأسلوب الصحيح:</b><br>• قف أمام الكابل السفلي<br>• امسك البار القصير<br>• اثنِ ذراعك لفوق — الكوع ثابت<br>• انزل ببطء<br><br><b>ميزته:</b> توتر مستمر على البايسبس طول الحركة.",
    gif: null
  },
  "Pulley Pushdown": {
    title: "Pulley Pushdown — ترايسبس بالكابل",
    category: "push",
    formNote: "<b>الأسلوب الصحيح:</b><br>• قف أمام الكابل العلوي<br>• امسك المقبض<br>• ادفع لتحت بافرد الذراع — <b>الكوع ثابت ملاصق للجسم</b><br>• ارجع ببطء<br><br><b>هذا التمرين الذهبي للترايسبس.</b>",
    gif: null
  },

  // ===== أجهزة الأرجل والسمانة =====
  "Leg Press": {
    title: "Leg Press — ضغط أرجل",
    category: "legs",
    formNote: "<b>الأسلوب الصحيح:</b><br>• اجلس وحط قدمك على المنصة بعرض الكتف<br>• ادفع المنصة لين رجلك تمتد (لا تقفل الركبة ١٠٠٪)<br>• ارجع ببطء لين الركبة توصل ٩٠ درجة — <b>لا تنزل أعمق من كذا</b><br><br><b>أول وزن:</b> ٤٠-٥٠ كجم — الأرجل أقوى عضلات الجسم<br><br><b>للسمانة:</b> نفس الجهاز، بس حط مقدمة قدمك بس على حافة المنصة وادفع بأصابع قدمك فقط.",
    gif: null
  },
  "Leg Extension": {
    title: "Leg Extension — فخذ أمامي",
    category: "legs",
    formNote: "<b>الأسلوب الصحيح:</b><br>• اجلس والوسادة على قدمك فوق الكاحل<br>• افرد رجلك لقدام لين تمتد<br>• ارجع ببطء — <b>هذا الجزء اللي يبني العضلة</b><br><br><b>أول وزن:</b> ١٠-١٥ كجم",
    gif: null
  },
  "Prone Leg Curl": {
    title: "Prone Leg Curl — فخذ خلفي",
    category: "legs",
    formNote: "<b>الأسلوب الصحيح:</b><br>• استلقِ على بطنك (وجهك لتحت)<br>• الوسادة على كاحلك من الخلف<br>• اثنِ رجلك وارفع الوزن لمؤخرتك<br>• انزل ببطء<br><br><b>أول وزن:</b> ١٠-١٥ كجم",
    gif: null
  },
  "Abductor": {
    title: "Abductor — فتح الأرجل",
    category: "legs",
    formNote: "<b>الأسلوب الصحيح:</b><br>• اجلس والوسائد على ركبتك من الخارج<br>• افتح رجلك للخارج ضد المقاومة<br>• ارجع ببطء<br><br><b>أول وزن:</b> ١٥-٢٠ كجم",
    gif: null
  },
  "Adductor": {
    title: "Adductor — ضم الأرجل",
    category: "legs",
    formNote: "<b>الأسلوب الصحيح:</b><br>• عكس Abductor — الوسائد على ركبتك من الداخل<br>• ضم رجلك للداخل<br>• ارجع ببطء<br><br><b>أول وزن:</b> ١٥-٢٠ كجم",
    gif: null
  },
  "Calf Raise": {
    title: "Calf Raise — سمانة",
    category: "legs",
    formNote: "<b>على جهاز Leg Press:</b><br>• حط مقدمة قدمك على حافة المنصة (الكعبين معلّقين)<br>• ادفع بأصابع قدمك — ارفع الكعب لأقصى ما يمكن<br>• انزل ببطء لين تحس تمدد في السمانة<br><br>الحركة <b>كاملة المدى</b> — هذا اللي يبني سمانة كبيرة.",
    gif: null
  },

  // ===== أجهزة البطن والخصر =====
  "Lower Back": {
    title: "Lower Back — أسفل الظهر",
    category: "core",
    formNote: "<b>الأسلوب الصحيح:</b><br>• اجلس والوسادة على ظهرك. ثبّت قدمك<br>• ادفع للخلف لين جسمك يصير مستقيم — <b>لا تحني ظهرك أكثر من اللازم</b><br>• ارجع ببطء<br><br><b>أول وزن:</b> ١٠-١٥ كجم — خفّف على ظهرك أول فترة.",
    gif: null
  },
  "Rotary Torso": {
    title: "Rotary Torso — خصر",
    category: "core",
    formNote: "<b>الأسلوب الصحيح:</b><br>• اجلس وثبّت رجلك<br>• امسك المقابض<br>• لف جسمك العلوي يمين — ارجع للوسط — لف يسار<br>• حركة بطيئة ومتحكمة — <b>لا تلف بسرعة أبداً</b><br><br><b>أول وزن:</b> ١٠ كجم",
    gif: null
  },
  "Abdominal Crunch": {
    title: "Abdominal Crunch — بطن",
    category: "core",
    formNote: "<b>الأسلوب الصحيح:</b><br>• اجلس وامسك المقابض فوق. ثبّت قدمك<br>• انحنِ لقدام — حس بعضلة البطن تنضغط<br>• ارجع ببطء — <b>لا ترجع بالكامل، خل التوتر على البطن</b><br><br><b>أول وزن:</b> ١٠-١٥ كجم",
    gif: null
  },
  "Hanging Leg Raise": {
    title: "Hanging Leg Raise — بطن سفلي",
    category: "core",
    formNote: "<b>الأسلوب الصحيح:</b><br>• قف على محطة Chin Up/Dip<br>• اسند ظهرك على المسند والكوع على الوسادات<br>• ارفع ركبك لصدرك ببطء<br>• انزل ببطء — <b>لا تأرجح جسمك</b><br><br><b>بدون وزن — بس وزن جسمك.</b>",
    gif: null
  },

  // ===== كارديو / إحماء =====
  "Skillrow": {
    title: "Skillrow — تجديف (إحماء)",
    category: "cardio",
    formNote: "<b>الأسلوب الصحيح:</b><br>• اجلس وثبّت قدمك في المكان المخصص<br>• امسك المقبض<br>• <b>ادفع برجلك أولاً</b>، بعدين اسحب بيدك لبطنك<br>• ارجع ببطء — رجلك ترجع أولاً ثم يدك<br><br><b>٥ دقائق بسرعة مريحة = إحماء مثالي</b>",
    gif: null
  },

  // ===== كابلات / صدر =====
  "Crossover Cables": {
    title: "Crossover Cables — كابل كروس (بديل Pectoral Fly)",
    category: "push",
    formNote: "<b>الأسلوب الصحيح:</b><br>• قف بين العمودين. اضبط الكابل على ارتفاع الكتف<br>• امسك المقبضين وخطوة وحدة للأمام<br>• جيب يديك لقدام لين يلتقون أمام صدرك — حس بالضغط على الصدر<br>• ارجع ببطء وافتح صدرك<br><br><b>ميزته عن Pectoral Fly:</b> حرية حركة أكبر وتمدد أعمق للصدر.<br><br><b>أول وزن:</b> ٥ كجم لكل جانب",
